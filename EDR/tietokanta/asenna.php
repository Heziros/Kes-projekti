...
$sql="DROP TABLE IF EXISTS tapahtuma";
$kysely = $yhteys->query($sql);
if($kysely) echo "Poistetaan vanhat tapahtuma-taulut..<br>";
...
$sql="CREATE TABLE IF NOT EXISTS tapahtuma(tid INT(6) NOT NULL AUTO_INCREMENT PRIMARY KEY,
otsikko VARCHAR(100),
sisaltö TEXT,
poistamispvm DATE NOT NULL,
jarjestaja VARCHAR(60),
tapahtumapvm DATE,
kloaika TIME,
lisatiedot TEXT, kid INT(6)) ENGINE InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci";
$kysely = $yhteys->query($sql);
if($kysely!=FALSE) echo "Taulu tapahtuma lisätty!<br>";
