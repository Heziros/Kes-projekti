...
{
    $sallitut=array('rekisteroidy','kirjaudu','juttu','kirjoittajan_uutiset','etusivu','DnD','rules');
...
{
    $sallitut=array('muokkaa_omia_tietoja','admin_etusivu');
    if(in_array($sivu,$sallitut))     {
        $sivu=$sivu.".php";
        require "./sisalto/$sivu";
    }
...
{
    $sana=trim($sana);//poistaa tyhj채t merkit merkkijonon alusta ja lopusta
